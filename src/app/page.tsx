        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-4 pb-16 pt-28 sm:px-6 sm:pb-20">
          <div className="fade-up max-w-2xl">
            ...
            <div className="fade-up-delay-2 mt-8 flex flex-wrap gap-3">
              <Link
                href="/maintenance"
                className="rounded-full bg-paper px-5 py-3 text-sm font-medium text-espresso transition hover:bg-white"
              >
                View maintenance calendar
              </Link>
              <Link
                href="/recipes"
                className="rounded-full border border-paper/35 px-5 py-3 text-sm font-medium text-paper transition hover:bg-paper/10"
              >
