  ...
  return (
    <div>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="display text-3xl text-espresso">Recipe recordings</h2>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-[1fr_auto_auto]">
        ...
        <label className="flex items-center gap-2 rounded-2xl border border-[var(--line)] bg-white/80 px-4 py-3 text-sm text-ink-soft">
          <input
            type="checkbox"
            checked={favoritesOnly}
            onChange={(event) => setFavoritesOnly(event.target.checked)}
            className="accent-[var(--espresso)]"
          />
          Favorites only
        </label>
      </div>
      ...
      {recipes.length === 0 ? (
        ...
        <div className="mt-8 overflow-x-auto rounded-[28px] border border-[var(--line)] bg-white/80 shadow-[var(--shadow)]">
